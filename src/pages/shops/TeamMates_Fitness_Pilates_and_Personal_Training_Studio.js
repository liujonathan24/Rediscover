...
const TeamMates_Fitness_Pilates_and_Personal_Training_Studio = () => {
  return (
    <div>
        <div>
          <img style={{ paddingTop:"1vh", paddingLeft:"29vw", paddingRight:"29vw", width:"42vw"}} src="..\..\TeamMates_Fitness_Pilates_and_Personal_Training_Studio.jpg" alt="Capezio"></img>
        </div>
        <div style={{marginBottom:"1vh"}}>
          ...
          <div className="bg-white flex flex-col justify-center items-center">
            <td style={{borderWidth:"3px", borderColor:"#1049a3", color:"#1049a3", padding:".2vh"}} onClick={()=> window.open("https://www.teammatesfitness.com/", "_blank")}>
